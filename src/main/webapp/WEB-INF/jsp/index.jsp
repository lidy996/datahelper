	...
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							<img src="/resources/images/张国荣.jpeg" class="layui-circle" width="35" height="35">
							<cite>yzqn</cite>
						</a>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="/resources/images/张国荣.jpeg"></a>
		...
		<div class="layui-footer footer">
			<p>copyright @2017 yzqn<a onclick="donation()" class="layui-btn layui-btn-danger layui-btn-small">作者</a></p>
		</div>
	</div>
